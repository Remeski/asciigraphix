...
fn main() {
    ...
    let mut ring1 = Shape::generate_ring(10.0, Point(-30.0, 0.0, 1.0));
    let mut ring2 = Shape::generate_ring(5.0, Point(10.0, 0.0, 1.0));
    let mut ring3 = Shape::generate_ring(7.0, Point(-5.0, 0.0, 1.0));
    let mut b: f64 = 0.0;
    ...
    loop {
        ...
        display.render_terminal(&ring1.combine(&ring2).combine(&ring3));
