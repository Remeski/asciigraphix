...
fn main() {
    ...
    let mut pnralellepiped = Shape::generate_parallelepiped(Point(0.0,0.0,0.0), Point(25.0, 0.0, 0.0), Point(5.0,10.0,5.0), Point(0.0,0.0,10.0));
    let mut b: f64 = 0.0;

    loop {
        paralellopiped.rotate(&Point(5.0,5.0,5.0), (0.0,0.1,0.0));
        // ring1.rotate(
